...
from utils import all_gather, set_random_seed
...
def setup_model_and_optimizer(args, set_optim=True):
    # get the model
    # ==================================
    # ===============NEW================
    # ==================================
        ...
        if args.peft == "lora":
            ...
            if args.peft_path is not None:
                ...
                peft_config = LoraConfig(
                    ...
                    r=args.peft_lora_r, lora_alpha=args.peft_lora_alpha,
                    lora_dropout=args.peft_lora_dropout
                )
                model = get_peft_model(model, peft_config)
            model.print_trainable_parameters()
            # Cast lora params to dtype for unification for later tensor flattening of all params (ref: https://github.com/huggingface/accelerate/issues/1620#issuecomment-2405439621)
...
def main():
    ...
    # ==================================
    # initialize(args)
    wandb.init(project="dolly_sft_80b")
    ...
    device = accelerator.device if accelerator else torch.cuda.current_device()
    ...
    model, optimizer, lr_scheduler = setup_model_and_optimizer(args, set_optim=args.do_train)
    # ==================================
    # ===============NEW================
    # ==================================
