...
WANDB_PRJ="i_am_sober_sft"

# model
MODEL_PATH="/scratch1/hieutn/hub/models--meta-llama--Meta-Llama-3-8B-Instruct/snapshots/e1945c40cd546c78e41f1151f4db032b271faeaa/"
MODEL_NAME="Llama-3-8B-ft-baseline"
MODEL_TYPE="llama"
# hp
BS=16
EVAL_BS=32
...
SAVE_PATH="/scratch1/hieutn/test-sft-debug/${MODEL_TYPE}/"
# seed
SEED=10
SEED_ORDER=10
