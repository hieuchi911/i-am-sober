...
# model
MODEL_PATH="/scratch1/hieutn/hub/models--meta-llama--Meta-Llama-3-70B-Instruct/snapshots/7129260dd854a80eb10ace5f61c20324b472b31c"  # path to model snapshots
...
export WANDB_NAME="sft-${MODEL_TYPE}-teacher-lr${LR}_bs${BS}"
